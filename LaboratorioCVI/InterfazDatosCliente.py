...
class DatosCliente(object):
    def setupUi(self, MainWindow):
        ...
        self.Domicilio.setStyleSheet("background-color: rgb(206, 206, 206);")
        self.Domicilio.setObjectName("Domicilio")
        self.Email = QtWidgets.QLineEdit(self.centralwidget)
        self.Email.setGeometry(QtCore.QRect(390, 290, 191, 20))
        self.Email.setStyleSheet("background-color: rgb(206, 206, 206);")
        ...
        self.Telefono.setStyleSheet("background-color: rgb(206, 206, 206);")
        self.Telefono.setObjectName("Telefono")
        self.DerivadoDe = QtWidgets.QLineEdit(self.centralwidget)
        self.DerivadoDe.setGeometry(QtCore.QRect(550, 350, 291, 20))
        self.DerivadoDe.setStyleSheet("background-color: rgb(206, 206, 206);")
        self.DerivadoDe.setText("")
        ...
        self.Domicilio.setReadOnly(True)
        self.DerivadoDe.setReadOnly(True)
        ...
        self.Email.setText(f"{main.cliente.email}")
        self.Telefono.setText(f"{main.cliente.telefono}")
        self.Domicilio.setText(f"{main.cliente.domicilio}")
        self.DerivadoDe.setText(f"{main.cliente.clinica_derivado}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Ventana Datos Cliente"))
        self.Titulo.setText(_translate("MainWindow", "DATOS CLIENTE"))
