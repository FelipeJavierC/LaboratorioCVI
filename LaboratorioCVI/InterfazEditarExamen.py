...
"border: 1px solid #222d5b ;")
        ...
        self.mascota_edit.setGeometry(QtCore.QRect(640, 300, 281, 22))
...
"border: 1px solid #222d5b ;")
        ...
        self.Tipo_edit.setGeometry(QtCore.QRect(240, 350, 261, 22))
...
"border: 1px solid #222d5b ;")
        ...
        self.fecha_edit.setGeometry(QtCore.QRect(640, 350, 91, 22))
...
"border: 1px solid #222d5b ;")
        ...
        self.hora_edit.setGeometry(QtCore.QRect(240, 400, 261, 22))
...
"")
        ...
        self.TxtNoEncontrado.setGeometry(QtCore.QRect(440, 547, 371, 21))
        font = QtGui.QFont()
        ...
        self.finalizar = QtWidgets.QCheckBox(self.principal)
        self.finalizar.setGeometry(QtCore.QRect(240, 452, 70, 17))
        self.finalizar.setObjectName("enEspera")
        ...
        self.finalizar.clicked.connect(lambda: self.checkFinalizar())

        self.botonAtras.clicked.connect(lambda: self.cambio2(MainWindow, InterfazElegirExamen.ElegirExamen,True))
        ...
        self.botonGuardar.clicked.connect(lambda: self.verifEstado(MainWindow))
 ...
 # No tocar
    ...
    def verifEstado(self,MainWindow):
        if estado == "True":
            self.guardar(MainWindow)
        elif estado == "False":
            self.guardar(MainWindow)
    ...
    def guardar(self,MainWindow):
        if estado == "True":
            if self.nombrecl_edit.text() == "" or self.ApellidoP_edit.text() == "" or self.ApellidoM_edit.text() == "" or self.mascota_edit.currentText() == "" \
                    ...
                    or self.resultado_edit.toPlainText() == "":
                ...
                datos = [self.nombrecl_edit, self.ApellidoP_edit, self.ApellidoM_edit, self.mascota_edit, self.Tipo_edit,
                         self.fecha_edit, self.hora_edit, self.precio_edit,self.resultado_edit]
                ...
                resultado = self.resultado_edit.toPlainText()
                main.borrarHorario(InterfazElegirExamen.examen.hora, InterfazElegirExamen.examen.fecha)
                main.borrarExamen(InterfazElegirExamen.examen.hora, InterfazElegirExamen.examen.fecha)
                main.editarExamen(nombres,apellidoP,apellidoM,mascota,tipo,fecha,hora,precio,resultado,estado)
                self.cambio(MainWindow,InterfazMenuExamen.MenuExamen)
        elif estado == "False":
            if self.nombrecl_edit.text() == "" or self.ApellidoP_edit.text() == "" or self.ApellidoM_edit.text() == "" or self.mascota_edit.currentText() == "" \
                    or self.Tipo_edit.currentText() == "" or self.fecha_edit.text() == "" or self.hora_edit.currentText() == "" or self.precio_edit.text() == "":
                self.TxtNoEncontrado.show()
                datos = [self.nombrecl_edit, self.ApellidoP_edit, self.ApellidoM_edit, self.mascota_edit,
                         self.Tipo_edit,
    ...
    def checkFinalizar(self):
        global estado
        if self.finalizar.isChecked():
            estado = "True"
            self.resultado_edit.setReadOnly(False)
        else:
            estado = "False"
            self.resultado_edit.setText("")
            self.resultado_edit.setStyleSheet("")
            self.resultado_edit.setReadOnly(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tit_labcvi.setText(_translate("MainWindow", "Editar Examen"))
