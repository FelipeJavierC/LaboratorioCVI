...
"border: 0px;")
        ...
        self.cliente.setStyleSheet("border-image:url(:/images/IMAGE_INTER/Borrar.png)")
...
"")
        ...
        self.botonContinuar.clicked.connect(lambda: self.guardar())
 ...
 # No tocar
    ...
    def guardar(self):
        rut = self.lineEdit_ingrsRut.text()
        usuario = main.buscarUsuario(rut)
        if usuario != False:
            main.borrarUsuario()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tit_labcvi.setText(_translate("MainWindow", "Borrar Usuario"))
        self.lineEdit_ingrsRut.setPlaceholderText(_translate("MainWindow", "                         Ingrese Rut del usuario a borrar"))
